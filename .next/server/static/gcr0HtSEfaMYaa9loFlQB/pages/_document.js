...
class NextScript extends _react.Component {
  ...
  render() {
    ...
    const pageScript = [/*#__PURE__*/_react.default.createElement("script", Object.assign({
      ...
      noModule: true
    } : undefined)),  true && /*#__PURE__*/_react.default.createElement("script", {
      async: true,
      "data-next-page": page,
      key: `${page}-modern`,
...
class InlineStylesHead extends next_document__WEBPACK_IMPORTED_MODULE_1__["Head"] {
  getCssLinks() {
  ...
  __getInlineStyles() {
    ...
    return files.filter(file => /\.css$/.test(file)).map(file => __jsx("style", {
      ...
      dangerouslySetInnerHTML: {
        __html: fs__WEBPACK_IMPORTED_MODULE_2__["readFileSync"](path__WEBPACK_IMPORTED_MODULE_3__["join"](process.cwd(), '.next', file), 'utf-8')
      }
    }));
  }
